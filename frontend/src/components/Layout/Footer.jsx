          ...
          <div className="footer-grid">
            ...
            <div className="footer-brand">
              <div className="footer-logo">
                ...
                <div className="logo-subtitle">Elevate Your Learning</div>
              </div>
              <p className="footer-description">
                Transform your career with our comprehensive learning platform. 
                Access expert-led courses, track your progress, and join a community 
            ...
            <div className="footer-links">
              ...
              <ul className="footer-list">
                <li><Link to="/courses" className="footer-link">Browse Courses</Link></li>
                <li><Link to="/dashboard" className="footer-link">Dashboard</Link></li>
                <li><Link to="/create-course" className="footer-link">Become Instructor</Link></li>
